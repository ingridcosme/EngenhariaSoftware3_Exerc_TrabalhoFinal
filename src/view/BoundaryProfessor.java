...
public class BoundaryProfessor extends Application {
	...
	public void start(Stage stage) throws Exception {
		...
		gridPane.add(new Label("Salário (R$)"), 0, 8);
		gridPane.add(txtSalario, 1, 8);
		...
		gridPane.add(botoesBox, 0, 9, 4, 1);
		...
		Bindings.bindBidirectional(txtSalario.textProperty(), control.salarioProperty(), converterNum);
